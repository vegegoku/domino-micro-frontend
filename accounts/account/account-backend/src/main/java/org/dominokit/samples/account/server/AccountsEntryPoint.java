package org.dominokit.samples.account.server;
...
public class AccountsEntryPoint implements ServerAppEntryPoint<VertxContext> {

    public static final Logger LOGGER = LoggerFactory.getLogger(AccountsEntryPoint.class);
    ...
    public void onModulesLoaded(VertxContext context) {
        ...
        AppDescriptor loansApp = new AppDescriptor("Accounts", "http://localhost:" + server.getPort() + "/accounts.nocache.js");
        loansApp.getMenuEntries().add(new MenuEntry("Account", "accounts"));
